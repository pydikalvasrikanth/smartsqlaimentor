...
const AnimatedTrace = lazyPanel(() => import("@/components/java/AnimatedTrace").then((m) => ({ default: m.AnimatedTrace })));
        ...
        <div className="max-w-[1400px] mx-auto px-4 py-3 flex flex-wrap items-center gap-2 sm:gap-3">
          ...
          <div className="leading-tight min-w-0 max-w-[40vw] sm:max-w-none">
            <h1 className="text-sm sm:text-base font-semibold tracking-tight truncate">
              ...
              <span className="hidden sm:inline">Java Interview Engine</span>
            </h1>
          ...
          <Link to="/java-tutorial" aria-label="Open visual tutorial" className="inline-flex items-center gap-1 text-xs font-mono px-2 py-1 rounded border border-border hover:bg-accent">
