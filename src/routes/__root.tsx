  ...
  head: () => ({
    meta: [
      ...
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        ...
        content: "TUov0Yw4fqwdft74XUASY2yzstEcs1Rbpc9MHCOcCiU",
      },
      { name: "author", content: "Lovable" },
      { title: "Smart AI Code Playground — AI Coding Interview Prep" },
    ...
    scripts: [
      {
        src: "https://www.googletagmanager.com/gtag/js?id=G-RMVD61RZ29",
        async: true,
      },
      {
        children:
          "window.dataLayer = window.dataLayer || [];function gtag(){dataLayer.push(arguments);}gtag('js', new Date());gtag('config', 'G-RMVD61RZ29');",
      },
      {
        ...
        children: JSON.stringify({
          ...
          url: "https://smartsqlaimentor.live",
