...
export const Route = createFileRoute("/cpp")({
  head: () => ({
    meta: [
      { title: "C / C++ Interview Engine — AI mentor practice" },
      ...
      { property: "og:description", content: "AI-graded C and C++ practice: language toggle, hints, complexity analysis, and progressive 15-question sessions." },
...
function CppWorkspace() {
  ...
  if (authLoading || !user) {
    return <SubjectSeoShell {...SUBJECT_SEO_CONTENT.cpp} />;
  }
        ...
        <div className="max-w-[1400px] mx-auto px-4 py-3 flex flex-wrap items-center gap-2 sm:gap-3">
          ...
          <div className="leading-tight min-w-0 max-w-[40vw] sm:max-w-none">
            <h1 className="text-sm sm:text-base font-semibold tracking-tight truncate">
              ...
              <span className="hidden sm:inline">C / C++ Interview Engine</span>
            </h1>
