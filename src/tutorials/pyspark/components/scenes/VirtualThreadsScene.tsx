...
export default function VirtualThreadsScene() {
  ...
  return (
    <group>
      <Text position={[0, 3.5, 0]} fontSize={0.28} color="#e25a1c" anchorX="center">
        {count} tasks → 4 executor cores
      </Text>
        ...
        return (
          <group key={i} position={[Math.cos(a) * 0.8, 0, Math.sin(a) * 0.8]}>
            <RoundedBox args={[0.6, 0.6, 0.6]} radius={0.08}>
              <meshStandardMaterial color="#e25a1c" emissive="#e25a1c" emissiveIntensity={0.5} />
            </RoundedBox>
          </group>
        );
      })}
