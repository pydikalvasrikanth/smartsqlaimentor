...
import { cppExtraCore } from "./cpp-extra-core";
import { cppExtraAdvanced } from "./cpp-extra-advanced";
...
const cppBase: Curriculum = {
  track: "cpp",
  name: "C++",
  accent: "var(--purple)",
  tagline:
    "Modern C++ from Hello World through RAII, templates, STL, move semantics, concurrency and C++20 concepts.",
  modules: [
    {
      id: "foundations",
      title: "1 · Foundations",
      ...
      lessons: [
        {
          ...
          cards: [
            ...
            c(
              ...
              "namespaces",
              B,
              "std:: prefixes standard library. Prefer explicit std:: over using namespace std;.",
              {
                example: {
                  code: `#include <string>\n#include <iostream>\n\nint main() {\n    std::string name = "Ada";\n    std::cout << "Hi, " << name << '\\n';\n}`,
                },
            ...
            c(
              ...
              "auto & Range for",
              P,
              "Let the compiler infer the type — cleaner and safer than repeating it.",
              {
                example: {
            ...
            c(4, "Build", K, "Compile with a modern standard flag.", {
              syntax: {
                code: `g++ -std=c++20 -Wall -Wextra -O2 hello.cpp -o hello\n./hello`,
                caption: "shell",
              },
            }),
          ],
              ...
              extras: [
                {
                  kind: "callout",
                  tone: "tip",
                  text: "Rule of thumb: pass by const& for anything larger than a machine word.",
                },
              ],
            }),
      ...
      lessons: [
        {
          ...
          cards: [
            ...
            c(
              ...
              "RAII",
              T,
              "Resource Acquisition Is Initialisation — every resource has an owner object.",
              {
                example: {
                ...
                extras: [
                  {
                    kind: "callout",
                    tone: "tip",
                    text: "RAII is why C++ doesn't need try/finally.",
                  },
                ],
              },
            ),
            c(
              ...
              "Rule of Zero/Five",
              P,
              "If you write a destructor, you probably need to write (or delete) copy & move too.",
              {
                extras: [
                  {
                    kind: "callout",
                    tone: "note",
                    text: "Prefer members that already manage themselves (std::vector, std::unique_ptr) — then you need nothing (Rule of Zero).",
                  },
                ],
              },
            ),
        ...
        },
        {
          ...
          cards: [
            c(
              ...
              "virtual",
              A,
              "Override in derived classes and call through a base pointer/reference.",
              {
                example: {
            ...
            c(
              ...
              "Virtual Destructor",
              R,
              "Base with virtual functions must have virtual dtor, or deletion is UB.",
              {
                example: {
                  code: `Shape* s = new Circle(2);\ndelete s;   // needs Shape::~Shape() virtual`,
                },
              },
            ),
          ],
              ...
              extras: [
                {
                  kind: "callout",
                  tone: "warn",
                  text: "Two shared_ptrs pointing at each other = leak. Break cycles with weak_ptr.",
                },
              ],
            }),
            c(
      ...
      lessons: [
        {
          ...
          cards: [
            ...
            c(
              ...
              "C++20 Concepts",
              G,
              "Constrain templates so errors are readable and intent is explicit.",
              {
                example: {
      ...
      lessons: [
        {
          ...
          cards: [
            ...
            c(
              ...
              B,
              "map = ordered tree (O(log n)); unordered_map = hash table (O(1) avg).",
              {
                example: {
      ...
      lessons: [
        {
          ...
          cards: [
            ...
            c(
              ...
              "C++20 Modules",
              P,
              "The modern replacement for #include — faster builds, real encapsulation.",
              {
                example: {
                ...
                extras: [
                  {
                    kind: "callout",
                    tone: "note",
                    text: "Modules avoid re-parsing headers per translation unit. Big compile-time wins.",
                  },
                ],
              },
            ),
...
export const cppCurriculum: Curriculum = withExtraLessons(
  cppBase,
  mergeExtras(cppExtraCore, cppExtraAdvanced),
);
